...
final class MobileDeviceIdentity {
  ...
  /// Stable, environment-scoped id generated by this mobile installation.
  /// It is intentionally independent from any desktop terminal device id.
...
final class MobileDeviceIdentityService {
  ...
  Future<MobileDeviceIdentity> _resolve() async {
    final existingId = await _store.readInstallationId();
    final id = existingId?.isNotEmpty == true ? existingId! : const Uuid().v4();
    if (existingId == null || existingId.isEmpty) {
      await _store.saveInstallationId(id);
    }
